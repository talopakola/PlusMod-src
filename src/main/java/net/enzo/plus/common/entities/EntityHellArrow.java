...
public class EntityHellArrow extends EntityArrow {
    ...
    public EntityHellArrow(World world, double x, double y, double z) {
        super(world, x, y, z);
    }

    public EntityHellArrow(World world, EntityLivingBase entity, EntityLivingBase entity2, float something, float otherthing) {
        super(world, entity, entity2, something, otherthing);
    }

    public EntityHellArrow(World world, EntityLivingBase entity, float something) {
    ...
    public void barrage() {
        for (int i=0; i<35; i++) {
            ...
            EntityArrow arrow = new EntityHellSubArrow(this.worldObj, x,y,z);
