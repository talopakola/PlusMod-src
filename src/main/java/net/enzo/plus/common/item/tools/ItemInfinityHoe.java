...
public class ItemInfinityHoe extends ItemHoe {
    private static final Item.ToolMaterial opHoe = EnumHelper.addToolMaterial("INFINITY_HOE", 9999, 9999, 999999F, 999.0F, 32);
