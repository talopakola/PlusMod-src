...
public class InventoryAbsoluteCraftingTable extends InventoryCrafting {
    private TileAbsoluteCraftingTable craft;
    private Container container;

    public InventoryAbsoluteCraftingTable(Container cont, TileAbsoluteCraftingTable table){
        super(cont, 9, 9);
        craft = table;
        container = cont;
    }
