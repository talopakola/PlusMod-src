...
public class MakeTheThings {
    public static void makeAll() {
        ...
        AbsoluteCraftingManager.getInstance().addRecipe(new ItemStack(InfinityItems.infinity_helmet), " EEEEEEE ", " EDDDDDE ", " ECCDCCE ", " EDDDDDE ", " EDDDDDC ", " ESSDSSE ", " E     E ", "         ", "         ", 'E', InfinityItems.existence, 'C', InfinityItems.realityCristal, 'D', InfinityItems.star_core, 'S', InfinityItems.star);
    }
}
