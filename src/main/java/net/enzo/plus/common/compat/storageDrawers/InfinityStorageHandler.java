...
public class InfinityStorageHandler {
    public static void storageTheUniverse() {
        AbsoluteCraftingManager.getInstance().addRecipe(new ItemStack(ModItems.upgradeCreative), "    X    ", "   XXX   ", "  XDDDX  ", " CDDDDDC ", "CDDDDDDDC", " CDDDDDC ", "  XDDDX  ", "   XXX   ", "    X    ", 'X', InfinityItems.existence, 'D',new ItemStack(ModItems.upgrade, 1, 6), 'C', InfinityItems.realityCristal
        );
    }
}
